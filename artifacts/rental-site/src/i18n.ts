...
export const translations = {
  az: {
    ...
    booking: {
      ...
      floor2: '2-ci Mərtəbə',
      wholeHouse: 'Bütün ev',
      whatsappGreeting: 'Salam! Rezervasiya etmək istəyirəm.',
      whatsappFloor: 'Mərtəbə',
      whatsappCheckin: 'Giriş tarixi',
      whatsappCheckout: 'Çıxış tarixi',
      whatsappNights: 'Gecə sayı',
      whatsappGuests: 'Qonaq sayı',
      whatsappNote: 'Qeyd',
      updated: 'Yeniləndi',
      refreshing: 'Canlı təqvim yenilənir...',
      waiting: 'Təqvim sinxronizasiyası gözlənilir',
      monthHint: 'Açıq günlər yaşıl, bağlı günlər qırmızı, keçmiş günlər boz rəngdə göstərilir.',
      previousMonth: 'Əvvəlki ay',
      nextMonth: 'Növbəti ay',
      available: 'Açıq',
      selected: 'Seçilmiş',
      blocked: 'Bağlı',
      feedErrorTitle: 'Bəzi təqvimlər yüklənmədi.',
      feedErrorHint: 'Mövcud tarixlər işləyən təqvimlərdən göstərilir.',
      feedErrorDetails: 'Detalları göstər',
      selectedFloor: 'Seçilmiş mərtəbə',
      clearDates: 'Tarixləri təmizlə',
      calendarOnly: 'Tarixləri yalnız yuxarıdakı təqvimdən seçin.',
      selectDates: 'Giriş və çıxış tarixini seçin.',
      requestReady: 'WhatsApp sorğusu avtomatik hazırlanacaq.',
      invalidRange: 'Cari tarix aralığı bağlı günə düşür və ya çıxış tarixi yanlışdır.',
      sendRequest: 'Rezervasiya sorğusunu WhatsApp ilə göndər',
  ...
  en: {
    ...
    booking: {
      title: 'Reservation',
      subtitle: 'Availability is synced from the Airbnb and Booking calendars. Pick a floor, check the live calendar, and send a WhatsApp request only if the dates work.',
      ...
      whatsappNights: 'Nights',
      whatsappGuests: 'Guests',
      whatsappNote: 'Note',
      updated: 'Updated',
      refreshing: 'Refreshing live calendars...',
      waiting: 'Waiting for feed sync',
      monthHint: 'Available dates are shown in green, blocked dates in red, and past dates in gray.',
      previousMonth: 'Previous month',
      nextMonth: 'Next month',
      available: 'Available',
      selected: 'Selected',
      blocked: 'Blocked',
      feedErrorTitle: 'Some feeds could not be loaded.',
      feedErrorHint: 'Availability is still shown from the calendars that responded.',
      feedErrorDetails: 'Show details',
      selectedFloor: 'Selected floor',
      clearDates: 'Clear dates',
      calendarOnly: 'Choose dates only from the calendar above.',
      selectDates: 'Select a check-in and check-out date.',
      requestReady: 'The WhatsApp request will be prefilled and ready to send.',
      invalidRange: 'The current range overlaps a blocked night or has an invalid end date.',
      sendRequest: 'Send reservation request via WhatsApp',
  ...
  ru: {
    ...
    booking: {
      title: 'Бронирование',
      subtitle: 'Доступность синхронизируется с календарями Airbnb и Booking. Выберите этаж, проверьте живой календарь и отправьте запрос в WhatsApp только если даты подходят.',
      months: ['Январь', 'Февраль', 'Март', 'Апрель', 'Май', 'Июнь', 'Июль', 'Август', 'Сентябрь', 'Октябрь', 'Ноябрь', 'Декабрь'],
      weekdays: ['Вс', 'Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб'],
      floor1: '1-й этаж',
      floor2: '2-й этаж',
      wholeHouse: 'Весь дом',
      whatsappGreeting: 'Здравствуйте! Я хотел бы забронировать.',
      whatsappFloor: 'Этаж',
      whatsappCheckin: 'Дата заезда',
      whatsappCheckout: 'Дата выезда',
      whatsappNights: 'Ночей',
      whatsappGuests: 'Гости',
      whatsappNote: 'Примечание',
      updated: 'Обновлено',
      refreshing: 'Обновление живых календарей...',
      waiting: 'Ожидание синхронизации календаря',
      monthHint: 'Доступные даты показаны зелёным, заблокированные даты красным, а прошедшие даты серым.',
      previousMonth: 'Предыдущий месяц',
      nextMonth: 'Следующий месяц',
      available: 'Доступно',
      selected: 'Выбрано',
      blocked: 'Заблокировано',
      feedErrorTitle: 'Некоторые календарные ленты не загрузились.',
      feedErrorHint: 'Доступность всё равно показывается из календарей, которые ответили.',
      feedErrorDetails: 'Показать детали',
      selectedFloor: 'Выбранный этаж',
      clearDates: 'Очистить даты',
      calendarOnly: 'Выбирайте даты только из календаря выше.',
      selectDates: 'Выберите дату заезда и выезда.',
      requestReady: 'Запрос WhatsApp будет подготовлен автоматически.',
      invalidRange: 'Текущий диапазон пересекает заблокированную дату или содержит неверную дату выезда.',
      sendRequest: 'Отправить запрос на бронирование в WhatsApp',
      checkin: 'Дата заезда',
